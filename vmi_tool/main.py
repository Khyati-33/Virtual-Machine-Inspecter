...
def main():
    ...
    parser.add_argument('--action', type=str, required=True, choices=['info', 'reboot', 'memory', 'network', 'process', 'filesystem', 'cpu', 'anomaly', 'snapshot', 'kernel',
                                                                      'alerts', 'gui', 'malware-analysis'], help='Action to perform on the virtual machine.')
